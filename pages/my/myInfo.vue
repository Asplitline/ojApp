		...
		<view class="mi-page  t-pg">
			<view class="mi-box">
				<u--form labelPosition="left" :model="infoData" :rules="rules" ref="infoData" errorType="toast" labelWidth="80" class="mi-form">
					...
					<u-form-item label="学号" prop="number" borderBottom class="mi-form-item"><u--input v-model="infoData.number" border="none"></u--input></u-form-item>

					<u-form-item label="昵称" prop="nickname" borderBottom class="mi-form-item"><u--input v-model="infoData.nickname" border="none"></u--input></u-form-item>
					<u-form-item label="真实姓名" prop="realname" borderBottom class="mi-form-item"><u--input v-model="infoData.realname" border="none"></u--input></u-form-item>
					...
					<u-form-item label="学校" prop="school" borderBottom class="mi-form-item"><u--input v-model="infoData.school" border="none"></u--input></u-form-item>
					<u-form-item label="Github" prop="github" borderBottom class="mi-form-item"><u--input v-model="infoData.github" border="none"></u--input></u-form-item>
					<u-form-item label="Blog" prop="blog" borderBottom class="mi-form-item"><u--input v-model="infoData.blog" border="none"></u--input></u-form-item>
