<template>
  <t-page class="entry-page">
    ...
    <t-icon type="icon-Close" class="close-page" @click.native="gotoIndex"></t-icon>
    ...
    <view class="entry-box" v-else-if="active === 'register'">
      ...
      <view class="entry-form">
        ...
        <view class="entry-form-item">
          ...
          <text class="check-code" @click="getCheckCode" :class="{ 'disabled-event': isClick }">{{
            isClick ? timer + 's' : '获取验证码'
          }}</text>
        </view>
